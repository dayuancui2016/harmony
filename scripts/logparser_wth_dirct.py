...
my_files = os.listdir(path) #get all file in the path
...
for logfile in my_files:
    # open logfile
    print("fileName is: " + logfile)
    with open(os.path.join(path, logfile), 'r') as file:
...
# print the results
print("ave1 = {} s\nave2 = {} s\nvalid_block_hashes = {} ".format(ave1, ave2, valid_block_hashes))